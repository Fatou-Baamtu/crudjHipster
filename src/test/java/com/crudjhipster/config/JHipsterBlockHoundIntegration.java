package com.crudjhipster.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.crudjhipster.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.crudjhipster.security.DomainUserDetailsService", "createSpringSecurityUser");
